...
if length(s) == length(t) && length(s) == length(edgeCost)
    ...
    [NodePathC,~] = dijkstra_kernel2(totalNodes,sNew,tNew,edgeCost,sourceNew,targetNew);
    ...
    [NodePathD,~] = dijkstra_kernel2(totalNodes,sNew,tNew,edgeResource,sourceNew,targetNew);
    ...
    if ResourceD > ResourceMax
        ...
        while true            
            ...
            [NodePathR,~] = dijkstra_kernel2(totalNodes,sNew,tNew,edgeCostL,sourceNew,targetNew);
